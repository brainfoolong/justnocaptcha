module.exports = async (JustNoCaptcha) => {
  ...
  for (const type of types) {
    const challenge = fs.readFileSync(JustNoCaptcha.verifiedSolutionsFolder + '/cross-challenge/' + type).toString()
    const hashFile = JustNoCaptcha.verifiedSolutionsFolder + '/' + (JustNoCaptcha.hash(challenge)) + '.pow'
