export default class JustNoCaptcha {
  ...
  // browser-strip-start
  // @ts-ignore
  public static verifiedSolutionsFolder: string = process?.env?.JUSTNOCAPTCHA_VERIFIED_SOLUTIONS_FOLDER
  // browser-strip-end
  ...
  public static hash (data: BufferSource | Uint8Array | string): string {
    ...
    return JustNoCaptcha.fmix<string>(h1) + JustNoCaptcha.fmix<string>(h2) + JustNoCaptcha.fmix<string>(h3) + JustNoCaptcha.fmix<string>(h4)
  }
  ...
  public static hashInt (data: BufferSource | Uint8Array | string): number {
    ...
    return JustNoCaptcha.fmix<number>(h1, false)
  }
  ...
  private static toUint8Array (data: any): Uint8Array {
    if (!JustNoCaptcha.encoder) {
      ...
      JustNoCaptcha.encoder = (data: any) => {
